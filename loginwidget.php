<?php
/*
	Plugin Name:Sign in Widget
	Plugin URI:http://wordpress.org/plugins/sign-in-widget
	Author:Arnob Protim Roy
	Author URI:http://profiles.wordpress.org/arnobprotimroy
...
class borno_login_widget extends WP_Widget {
...
add_action( 'widgets_init', create_function( '', 'register_widget( "borno_login_widget" );' ) );
...
//////////////////////////////////////////////////////////////
//shortcode 
function borno_login_shortcode(){
		if ( !is_user_logged_in() ){
		// if user login
		 $args = array(
		'echo' => true,
...
add_shortcode('signinform','borno_login_shortcode');
add_shortcode('signinwidget','borno_login_shortcode');
add_shortcode('signin','borno_login_shortcode');